...
import { IProps, TOpen, TClose, TStyle, IHandles, TPosition } from 'react-native-modalize/lib/options';
// import { useDimensions } from 're /utils/use-dimensions';
import { useDimensions } from 'react-native-modalize/lib/utils/use-dimensions';
import { getSpringConfig } from 'react-native-modalize/lib//utils/get-spring-config';
import { isIphoneX, isIos, isAndroid } from 'react-native-modalize/lib//utils/devices';
import { invariant } from 'react-native-modalize/lib//utils/invariant';
import { composeRefs } from 'react-native-modalize/lib//utils/compose-refs';
import s from 'react-native-modalize/lib/styles';
